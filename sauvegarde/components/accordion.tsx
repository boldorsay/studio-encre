...
export default function Accordion({ sectionTitle, sectionIntro, items, tinaData }: AccordionProps) {
        ...
        <section className="accordion-section">
            <div className="accordion-layout">
                <div className="accordion-header-section">
                    <h2 className="accordion-title" data-tina-field={tinaField(tinaData.page.accordion, "title")}>
                        {sectionTitle || "Services"}
                    </h2>
                    <div className="accordion-description" data-tina-field={tinaField(tinaData.page.accordion, "introText")}>
                ...
                <div className="accordion-container">
                    {validItems.map((item, index) => (
                        <AccordionItem
                            ...
                            itemField={tinaField(tinaData.page.accordion.items[index], "title")}
                            imageField={tinaField(tinaData.page.accordion.items[index], "image")}
                            contentField={tinaField(tinaData.page.accordion.items[index], "content")}
                        />
                    ))}
                </div>
            </div>
